...
Mking_youtube = random.choice(["https://youtube.com/@nooratx7159])

youtuber = BEST TECH 

def youtube(https://youtube.com/@nooratx7159):
...
def telegram():
	...
	os.system("https://t.me/BEST_TECHING_001")
